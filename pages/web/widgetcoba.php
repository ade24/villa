...
if(isset($_POST['button']))
{
	...
	$q=mysql_query("Select * from reservations Where resv_date between '".$_POST['tgl_a']."' and '".$_POST['tgl_b']."' and idclass='".$_POST['rooms']."'"); 
		...
		if($rc==0) { 
				...
				unset($_SESSION['ada']); 
				_direct("?y=".session_id()."&page="._encodeParam("reservasi")); 
				echo "Tanggal yang anda inputkan tidak benar atau villa yang anda pilih stoknya habis."; 
		}
		echo "Tanggal yang anda inputkan tidak benar atau villa yang anda pilih stoknya habis ntuk tanggal tersebut."; 
	} 
