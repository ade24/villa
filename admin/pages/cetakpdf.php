...
$file->SetTitle('Laporan Data Reservasi Villa');
$file->SetSubject('Reservasi');
$file->SetKeywords('laporan, reservasi, villa');

$file->AddPage();
//$file->SetMargins('100px','600px','100');
$file->SetFont("times", "", 12);
$file->SetFont("times", "B", 32);
$file->Cell(0,0,"Villa Corner",0,1,"C");
//$file->SetFont("times", "B", 32);
//$file->Cell(0,0,"DIPLOMA IPB",0,1,"C");
$file->SetFont("times", "", 12);

$html = '<h1>Data Reservasi Villa</h1><u>Lampiran :</u> 1 Berkas<br><hr>&nbsp;<br><br>';
...
$html .= '</table><br><br><br>Bandung, '.date('d-m-Y').'<br>
<b>Admintrator Hotel</b><br><br><br><br>
<u>H. Tantan Takiyudin LC</u>';
